...
|:---------:|:-------------|:-----------------------|:------------|
| **C1: Information Gain** | Actively reduces epistemic uncertainty via belief-updating observations | *Belief Stagnation* 鈥?frozen internal model under distribution shift | ...where it knows least |
| **C2: Value Improvement** | Converts new information into durable policy improvement | *Value Stagnation* 鈥?local optima lock-in, surrogate misalignment | ...what it cannot yet do well |
| **C3: Epistemic Reachability** | Preserves positive visitation over belief-consistent regions | *Reachability Collapse* 鈥?irreversible contraction of behavioural diversity | ...where it might otherwise never go |

These form a closed loop: **gain information 鈫?convert to value 鈫?keep the capacity to gain information alive 鈫?...**
...
|:-----------|:------------------|:------------------------|
| **L1鈫扡2: Responder 鈫?Reasoner** | **Reasoning space** | Hypotheses, reasoning trajectories, latent thought representations |
| **L2鈫扡3: Reasoner 鈫?Agent** | **Perception & action space** | Tool invocation, sensorimotor loops, memory management |
| **L3鈫扡4: Agent 鈫?Prospector** | **Imagination space** | Counterfactual futures in learned world models, dual real-imagined exploration |
| **L4鈫扡5: Prospector 鈫?Ecosystem** | **Coordination space** | Communication topologies, role assignments, shared world models |

### 1.4 3脳5 Taxonomy

Our survey is organized as a **3脳5 taxonomy** crossing three signal-driven methodologies with the five levels:
...
## 2. Levels 1鈥?: Responder 鈫?Reasoner 鈥?Reasoning-Space Exploration
...
<p align="center"><i>Figure: Levels 1鈥? Reasoning-Space Exploration 鈥?Why (entropy escalation & reward stagnation), Where (tokens 鈫?turns 鈫?latent trajectories), and How (uncertainty / competence / reachability-driven).</i></p>
...
## 3. Level 3: Reasoner 鈫?Agent 鈥?Perception- & Action-Space Exploration
...
| 2025-10 | **蟺_RL** | First online PPO/GRPO RL fine-tuning for flow-matching VLA | [蟺RL: Online RL Fine-Tuning for Flow-Based Vision-Language-Action Models](https://arxiv.org/abs/2510.25889) | - |
...
| 2025-11 | **蟺*鈧€.鈧?* | Flow-matching VLA that learns from online experience via offline RL | [蟺*鈧€.鈧? A VLA That Learns From Experience](https://arxiv.org/abs/2511.14759) | - |
